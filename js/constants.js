...
var FUNCTION_AREAS = ['ALL','FA0', 'FA1.1', 'FA1.2', 'FA2', 'FA3.1', 'FA3.2', 'FA4', 'FA5', 'FA6', 'MO1', 'MO2', 'MO3', 'MO4', 'N.A'];
...
var INPUTS = ['ALL', 'TQC', 'BQC', 'PROD', 'NTG', 'ECO', 'QAS', 'BRIEFING', 'TAKT RED', 'MANUT', 'VDT', 'AUDIT'];
...
var TABLE_CONTENT = [
    ...
    // { header: "NEXT DEL", field: "phaseDelivery" },
    { header: "HANDOVER", field: "handover" },
    { header: "CALENDARIO", field: "calendar" },
...
//var SERVER = 'http://localhost:59450';
